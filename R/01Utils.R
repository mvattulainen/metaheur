...
#' To be used with metaheur() or metaheurhyper() functions as an example grid.
#'
...
#' result <- metaheur(examplegrid) \cr
#' @format A GridClass object
"examplegrid"

#' metaheuristic optimization example
#'
#' An example of metaheuristic search with examplegrid preprocessing combinations. \cr
#' Two restarts, each 50 iterations and 10 times repeated holdout validation.
#'
#' result <- metaheur(examplegrid, startnum=2, iterations=50, nholdout=10, cores=2) \cr
...
#'
#' An example result to be plotted with plotsearchpath().
#'
...
#' plotsearchpath(examplehyperparam) \cr
#' @format list
"examplehyperparam"
